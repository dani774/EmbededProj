...
function* SignUp(action) {
    const { age, bloodType, email ,firstName, gender, height, lastName, password, weight } = action.payload.values;
    const body = {age, bloodType, email ,firstName, gender, height, lastName, password, weight};
    yield call(() =>
        new Ajax({
            success: response => {
            },
